        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 overflow-hidden">
            <div className="floating-item absolute left-1/4 top-1/4 opacity-30">
              <Shield className="text-white/20 w-24 h-24" />
            </div>
            ...
            <div className="floating-item absolute left-3/4 top-1/2 opacity-20" style={{animationDelay: "4s"}}>
              <AlertTriangle className="text-white/20 w-20 h-20" />
            </div>
          </div>
          
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-block mb-6 p-3 rounded-full bg-white/5 border border-white/10 animate-fade-in">
                <Shield className="h-10 w-10 text-white" />
              </div>
              
              <h1 className="text-5xl md:text-7xl font-bold text-gradient mb-6 animate-fade-in leading-tight tracking-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up" style={{ animationDelay: "0.4s" }}>
                <Button asChild size="lg" className="interactive-button min-w-[200px] rounded-full py-6">
                  <Link to="/verify" className="flex items-center gap-2">
                    Verify News Now <ArrowRight className="w-4 h-4" />
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="bg-transparent border-white/20 hover:bg-white/5 text-white min-w-[200px] rounded-full py-6">
            ...
            <div className="mt-16 text-center animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <button className="flex flex-col items-center gap-2 text-sm text-gray-400 mx-auto transition-colors hover:text-white">
          ...
          <div className="max-w-7xl mx-auto px-6 relative">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={feature.title}
                  className="glass-card p-8 rounded-2xl glowing-border animate-slide-up"
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="glass-card rounded-3xl p-10 md:p-16 text-center max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gradient">Ready to Verify?</h2>
